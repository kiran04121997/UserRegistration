...
namespace UserRegistration
{
    ...
    public class UnitTest1
    {
        ...
        {
            string excepted = "false";
            var actual = UserRegister.ValidateEmailID("KIRAN.bh@g.in.com");
            Assert.AreEqual(excepted, actual);
            var actual1 = UserRegister.ValidateEmailID(".bh@gmail.com.in");
            Assert.AreEqual(excepted, actual1);
        }
        [TestMethod]
        ...
        {
            string excepted = "false";
            var actual = UserRegister.ValidateMobileNumber("9921925459315");
            Assert.AreEqual(excepted, actual);
            var actual1 = UserRegister.ValidateMobileNumber("23 992192545945");
            Assert.AreEqual(excepted, actual1);
            var actual2 = UserRegister.ValidateMobileNumber("91 992192545945");
        ...
        {
            string excepted = "true";
            var actual = UserRegister.ValidatePassword("KiranB76@#$");
            Assert.AreEqual(excepted, actual);
        }
        [TestMethod]
